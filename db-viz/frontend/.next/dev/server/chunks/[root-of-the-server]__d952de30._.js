...
function proxy(request) {
    ...
    if (request.nextUrl.pathname.startsWith('/_next/static/') || request.nextUrl.pathname.endsWith('.js') || request.nextUrl.pathname.endsWith('.css')) {
    ...
    if (request.nextUrl.pathname === '/' || request.nextUrl.pathname.match(/^\/(pricing|privacy-policy|terms-of-service|documentation)$/)) {
